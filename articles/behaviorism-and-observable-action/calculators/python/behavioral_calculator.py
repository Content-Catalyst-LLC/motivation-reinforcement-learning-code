#!/usr/bin/env python3
"""Self-contained behavioral calculator for Behaviorism and the Study of Observable Action.
...
def main() -> None:
    ...
    result = {
        "series": 'Motivation, Reinforcement, and Learning',
        "article": 'Behaviorism and the Study of Observable Action',
